...
namespace evaluation_fournisseur_version_actuel.Server.Dto
{
    ...
    {
        // NomFournisseur optionnel pour mise à jour partielle
        public UpdateNomFournisseurDto? NomFournisseur { get; set; }

        // Propriétés optionnelles pour mise à jour partielle
    ...
    public class UpdateNomFournisseurDto
    {
